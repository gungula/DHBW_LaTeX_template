...
\fancypagestyle{plain}{%
        ...
        \fancyhead[R]{
            ...
            \iflang{de}{
			   \begin{textblock*}{188mm}(0mm,0mm)            	
                %\includegraphics[height=2.7cm]{-todo-}  % Logo der Partnerfirma in Kopfzeile von content-Seiten
               \end{textblock*}
            }
            \iflang{en}{
            	\begin{textblock*}{188mm}(0mm,0mm)            	
                %\includegraphics[height=2.2cm]{-todo-}  % Logo der Partnerfirma in Kopfzeile von content-Seiten
            	\end{textblock*}
            }
        }
        \fancyfoot[L]{
